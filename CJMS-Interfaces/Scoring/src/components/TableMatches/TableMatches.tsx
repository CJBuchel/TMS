...
export default class TableMatches extends Component<IProps, IState> {
  ...
  getTable() {
    ...
    if (this.props.external_tableMatches.length > 0) {
      for (const match of this.props.external_tableMatches) {
        content.push(
          <tr
