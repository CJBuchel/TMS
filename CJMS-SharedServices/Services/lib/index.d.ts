...
export { request_namespaces, comm_service, ITeamScore, initITeamScore, ITeam, initITeam, IMatch, initIMatch, IEvent, initIEvent, IUser, initIUser, IJudgingSession, initIJudgingSession };
