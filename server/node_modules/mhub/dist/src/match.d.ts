export declare type Matcher = (value: string) => boolean;
export declare type MatchSpec = string | string[] | Matcher;
/**
 ...
 */
export declare function getMatcher(pattern?: MatchSpec): Matcher;
