...
(function (OutputFormat) {
    OutputFormat[OutputFormat["Human"] = 0] = "Human";
    OutputFormat[OutputFormat["Text"] = 1] = "Text";
    OutputFormat[OutputFormat["JsonData"] = 2] = "JsonData";
    OutputFormat[OutputFormat["Json"] = 3] = "Json";
})(OutputFormat || (OutputFormat = {}));
function parseOutputFormat(s) {
    switch (s) {
        case "human":
...
(function (InputFormat) {
    InputFormat[InputFormat["Text"] = 0] = "Text";
    InputFormat[InputFormat["Json"] = 1] = "Json";
})(InputFormat || (InputFormat = {}));
function parseInputFormat(s) {
    switch (s) {
        case "text":
...
main();
//# sourceMappingURL=mhub-client.js.map