 ...
 */
export declare type Command = SubscribeCommand | UnsubscribeCommand | PublishCommand | PingCommand | LoginCommand;
/**
 * All supported responses (i.e. server to client)
 */
export declare type Response = MessageResponse | SubAckResponse | UnsubAckResponse | PubAckResponse | PingAckResponse | LoginAckResponse | ErrorResponse;
/**
 ...
 */
export declare function hasSequenceNumber(msg: any): msg is ObjectWithSequenceNumber;
