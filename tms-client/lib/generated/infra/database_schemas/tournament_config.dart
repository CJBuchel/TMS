...
final String? season;
                ...
                const TournamentConfig({required this.name ,required this.backupInterval ,required this.retainBackups ,required this.endGameTimerLength ,required this.timerLength ,this.season ,});
...
static String  toSchema()=>TmsRustLib.instance.api.crateInfraDatabaseSchemasTournamentConfigTournamentConfigToSchema();
        ...
        @override
        int get hashCode => name.hashCode^backupInterval.hashCode^retainBackups.hashCode^endGameTimerLength.hashCode^timerLength.hashCode^season.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is TournamentConfig &&
                ...
                && name == other.name&& backupInterval == other.backupInterval&& retainBackups == other.retainBackups&& endGameTimerLength == other.endGameTimerLength&& timerLength == other.timerLength&& season == other.season;
