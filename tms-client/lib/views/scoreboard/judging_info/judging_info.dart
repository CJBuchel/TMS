...
class JudgingInfo extends StatefulWidget {
  final List<JudgingSession> judgingSessions;

  const JudgingInfo({Key? key, required this.judgingSessions}) : super(key: key);

  @override
  _JudgingInfoState createState() => _JudgingInfoState();
}

class _JudgingInfoState extends State<JudgingInfo> {
  ...
  @override
  void didUpdateWidget(covariant JudgingInfo oldWidget) {
