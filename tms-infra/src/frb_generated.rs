...
fn wire__crate__api__simple__test_struct_from_json_impl(port_: flutter_rust_bridge::for_generated::MessagePort, ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr, rust_vec_len_: i32, data_len_: i32) {
  FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
    flutter_rust_bridge::for_generated::TaskInfo {
...
fn wire__crate__api__simple__test_struct_to_json_impl(port_: flutter_rust_bridge::for_generated::MessagePort, ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr, rust_vec_len_: i32, data_len_: i32) {
  FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
    flutter_rust_bridge::for_generated::TaskInfo {
...
impl SseDecode for crate::api::simple::TestStruct {
  ...
  fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
    ...
    let mut var_age = <i32>::sse_decode(deserializer);
    return crate::api::simple::TestStruct { name: var_name, age: var_age };
  }
}
...
fn pde_ffi_dispatcher_primary_impl(func_id: i32, port: flutter_rust_bridge::for_generated::MessagePort, ptr: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr, rust_vec_len: i32, data_len: i32) {
  ...
  match func_id {
    ...
    4 => wire__crate__api__simple__test_struct_from_json_impl(port, ptr, rust_vec_len, data_len),
    5 => wire__crate__api__simple__test_struct_to_json_impl(port, ptr, rust_vec_len, data_len),
    _ => unreachable!(),
  }
}
...
impl flutter_rust_bridge::IntoDart for crate::api::simple::TestStruct {
  fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
    [self.name.into_into_dart().into_dart(), self.age.into_into_dart().into_dart()].into_dart()
  }
}
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive for crate::api::simple::TestStruct {}
...
impl SseEncode for crate::api::simple::TestStruct {
  ...
  fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
    ...
    <i32>::sse_encode(self.age, serializer);
  }
}
