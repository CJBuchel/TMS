...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -522100785;
...
fn pde_ffi_dispatcher_sync_impl(func_id: i32, ptr: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr, rust_vec_len: i32, data_len: i32) -> flutter_rust_bridge::for_generated::WireSyncRust2DartSse {
  ...
  match func_id {
    ...
    50 => wire__crate__infra__network_schemas__socket_protocol__server_socket_protocol__tms_server_match_load_event_from_json_string_impl(ptr, rust_vec_len, data_len),
    51 => wire__crate__infra__network_schemas__socket_protocol__server_socket_protocol__tms_server_match_load_event_to_json_string_impl(ptr, rust_vec_len, data_len),
    52 => wire__crate__infra__network_schemas__socket_protocol__server_socket_protocol__tms_server_match_load_event_to_schema_impl(ptr, rust_vec_len, data_len),
