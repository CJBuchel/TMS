    ...
    FllBlueprint {
      ...
      robot_game_questions: vec![
        ...
        Question {
          ...
          input: QuestionInput::Categorical(CategoricalQuestion {
            options: vec![
              ...
              CategoricalOption { label: "Blue".to_string(), score: 10 },
              CategoricalOption { label: "Pink".to_string(), score: 20 },
              CategoricalOption { label: "Orange".to_string(), score: 30 },
            ],
            default_option: "No".to_string(),
          }),
          rules: vec![],
        ...
        Question {
          ...
          input: QuestionInput::Categorical(CategoricalQuestion {
            options: vec![
              CategoricalOption { label: "None".to_string(), score: 0 },
              CategoricalOption { label: "Dark blue".to_string(), score: 10 },
              CategoricalOption {
        ...
        Question {
          ...
          input: QuestionInput::Categorical(CategoricalQuestion {
            options: vec![
              CategoricalOption { label: "None".to_string(), score: 0 },
              CategoricalOption { label: "Yellow".to_string(), score: 10 },
              CategoricalOption { label: "Green".to_string(), score: 20 },
              CategoricalOption { label: "Blue".to_string(), score: 30 },
            ],
            default_option: "None".to_string(),
          }),
          rules: vec![],
        ...
        Question {
          ...
          input: QuestionInput::Categorical(CategoricalQuestion {
            options: vec![
              ...
              CategoricalOption { label: "7".to_string(), score: 35 },
            ],
            default_option: "0".to_string(),
          }),
          rules: vec![],
