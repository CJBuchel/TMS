...
use super::{filters::{pulse_filter::pulse_filter, register_filter::registration_filter, websocket_filter::websocket_filter}, handlers::handle_rejection, login_filter::login_filter, ClientMap};
pub struct Network {
  db: SharedDatabase,
  clients: ClientMap,
  local_ip: String,
