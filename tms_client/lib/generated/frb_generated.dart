...
class TmsRustLib
  ...
  @override
  int get rustContentHash => -299985328;

  static const kDefaultExternalLibraryLoaderConfig =
      ExternalLibraryLoaderConfig(
    stem: 'tms_infra',
    ioDirectory: '../tms_infra/target/release/',
    webPrefix: 'pkg/',
  );
}
...
abstract class TmsRustLibApi extends BaseApi {
  ...
  String crateInfraNetworkSchemasBackupRequestsBackupGetNamesInfoToJsonString(
      {required BackupGetNamesInfo that});

  String crateInfraNetworkSchemasBackupRequestsBackupGetNamesInfoToSchema();

  BackupGetNamesResponse
  ...
  String
      crateInfraNetworkSchemasBackupRequestsBackupGetNamesResponseToJsonString(
          {required BackupGetNamesResponse that});

  String crateInfraNetworkSchemasBackupRequestsBackupGetNamesResponseToSchema();
  ...
  String crateInfraNetworkSchemasBackupRequestsBackupRestoreRequestToJsonString(
      {required BackupRestoreRequest that});

  String crateInfraNetworkSchemasBackupRequestsBackupRestoreRequestToSchema();
  ...
  ErrorMessage crateInfraNetworkSchemasErrorsErrorMessageDefault();
  ...
  FllBlueprint crateInfraFllInfraFllBlueprintFllBlueprintDefault();

  FllBlueprint crateInfraFllInfraFllBlueprintFllBlueprintFromJsonString(
      {required String json});

  int crateInfraFllInfraFllBlueprintMapFllBlueprintMapCalculateScore(
      {required FllBlueprint blueprint, required List<QuestionAnswer> answers});

  FllBlueprint? crateInfraFllInfraFllBlueprintMapFllBlueprintMapGetFllBlueprint(
      {required String season});

  List<String> crateInfraFllInfraFllBlueprintMapFllBlueprintMapGetSeasons();
  ...
  GameMatch crateInfraDatabaseSchemasGameMatchGameMatchDefault();
  ...
  GameScoreSheet crateInfraDatabaseSchemasGameScoreSheetGameScoreSheetDefault();
  ...
  GameTable crateInfraDatabaseSchemasGameTableGameTableDefault();
  ...
  void crateInfraInitApp();

  JudgingPod crateInfraDatabaseSchemasJudgingPodJudgingPodDefault();
  ...
  JudgingSession crateInfraDatabaseSchemasJudgingSessionJudgingSessionDefault();
  ...
  String crateInfraDatabaseSchemasJudgingSessionJudgingSessionPodToJsonString(
      {required JudgingSessionPod that});

  String crateInfraDatabaseSchemasJudgingSessionJudgingSessionPodToSchema();
  ...
  LoginRequest crateInfraNetworkSchemasLoginRequestsLoginRequestDefault();
  ...
  LoginResponse crateInfraNetworkSchemasLoginRequestsLoginResponseDefault();
  ...
  FllBlueprint crateInfraFllInfraSeasonsFll2023MasterPieceGetFllGame(
      {required MasterPiece that});

  String crateInfraFllInfraSeasonsFll2023MasterPieceGetSeason(
      {required MasterPiece that});
  ...
  Mission crateInfraFllInfraMissionMissionDefault();
  ...
  QuestionAnswer crateInfraFllInfraQuestionQuestionAnswerDefault();
  ...
  Question crateInfraFllInfraQuestionQuestionDefault();

  Question crateInfraFllInfraQuestionQuestionFromJsonString(
      {required String json});

  int crateInfraFllInfraQuestionQuestionGetScore(
      {required Question that, required Map<String, QuestionAnswer> answers});

  int? crateInfraFllInfraRuleEngineQuestionRuleApply(
      {required QuestionRule that,
      required Map<String, QuestionAnswer> answers});

  bool crateInfraFllInfraRuleEngineQuestionRuleEvaluate(
      {required QuestionRule that,
      required Map<String, QuestionAnswer> answers});

  QuestionRule crateInfraFllInfraRuleEngineQuestionRuleNew(
  ...
  RobotGameToggleTeamCheckInRequest
      crateInfraNetworkSchemasRobotGameMatchRequestsRobotGameToggleTeamCheckInRequestDefault();

  RobotGameToggleTeamCheckInRequest
      crateInfraNetworkSchemasRobotGameMatchRequestsRobotGameToggleTeamCheckInRequestFromJsonString(
          {required String json});

  String
      crateInfraNetworkSchemasRobotGameMatchRequestsRobotGameToggleTeamCheckInRequestToJsonString(
          {required RobotGameToggleTeamCheckInRequest that});

  String
      crateInfraNetworkSchemasRobotGameMatchRequestsRobotGameToggleTeamCheckInRequestToSchema();

  FllBlueprint crateInfraFllInfraSeasonsFll2024SubmergedGetFllGame(
      {required Submerged that});

  String crateInfraFllInfraSeasonsFll2024SubmergedGetSeason(
      {required Submerged that});

  List<QuestionValidationError>
      crateInfraFllInfraSeasonsFll2024SubmergedValidate(
          {required Submerged that,
          required Map<String, QuestionAnswer> answers});

  Team crateInfraDatabaseSchemasTeamTeamDefault();
  ...
  TmsCategory crateInfraDatabaseSchemasCategoryTmsCategoryDefault();

  TmsCategory crateInfraDatabaseSchemasCategoryTmsCategoryFromJsonString(
      {required String json});

  String crateInfraDatabaseSchemasCategoryTmsCategoryToJsonString(
      {required TmsCategory that});

  String crateInfraDatabaseSchemasCategoryTmsCategoryToSchema();
  ...
  TmsDate crateInfraDatabaseSchemasTmsTimeTmsDateTmsDateDefault();

  TmsDuration crateInfraDatabaseSchemasTmsTimeTmsDateTmsDateDifference(
      {required TmsDate that, required TmsDate other});

  TmsDuration crateInfraDatabaseSchemasTmsTimeTmsDateTmsDateDuration(
      {required TmsDate that});

  TmsDate crateInfraDatabaseSchemasTmsTimeTmsDateTmsDateFromJsonString(
      {required String json});

  bool crateInfraDatabaseSchemasTmsTimeTmsDateTmsDateIsAfter(
      {required TmsDate that, required TmsDate other});

  bool crateInfraDatabaseSchemasTmsTimeTmsDateTmsDateIsBefore(
      {required TmsDate that, required TmsDate other});

  bool crateInfraDatabaseSchemasTmsTimeTmsDateTmsDateIsSameMoment(
      {required TmsDate that, required TmsDate other});

  TmsDate crateInfraDatabaseSchemasTmsTimeTmsDateTmsDateNew(
      {required int year, required int month, required int day});

  TmsDate crateInfraDatabaseSchemasTmsTimeTmsDateTmsDateNow();
  ...
  TmsDateTime crateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeDefault();

  TmsDuration crateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeDifference(
      {required TmsDateTime that, required TmsDateTime other});

  TmsDuration crateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeDuration(
  ...
  bool crateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeIsAfter(
      {required TmsDateTime that, required TmsDateTime other});

  bool crateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeIsBefore(
      {required TmsDateTime that, required TmsDateTime other});

  bool crateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeIsSameMoment(
      {required TmsDateTime that, required TmsDateTime other});

  TmsDateTime crateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeNew(
      {TmsDate? date, TmsTime? time});

  TmsDateTime crateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeNow();

  String crateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeToJsonString(
      {required TmsDateTime that});

  String crateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeToSchema();

  String crateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeToString(
      {required TmsDateTime that});

  String crateInfraDatabaseSchemasTmsTimeTmsDateTmsDateToJsonString(
      {required TmsDate that});

  String crateInfraDatabaseSchemasTmsTimeTmsDateTmsDateToSchema();

  String crateInfraDatabaseSchemasTmsTimeTmsDateTmsDateToString(
      {required TmsDate that});

  TmsDuration crateInfraDatabaseSchemasTmsTimeTmsDurationTmsDurationAdd(
  ...
  TmsTime crateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeDefault();

  TmsDuration crateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeDifference(
      {required TmsTime that, required TmsTime other});

  TmsDuration crateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeDuration(
      {required TmsTime that});

  TmsTime crateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeFromJsonString(
      {required String json});

  bool crateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeIsAfter(
      {required TmsTime that, required TmsTime other});

  bool crateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeIsBefore(
      {required TmsTime that, required TmsTime other});

  bool crateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeIsSameMoment(
      {required TmsTime that, required TmsTime other});

  TmsTime crateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeNew(
      {required int hour, required int minute, required int second});

  TmsTime crateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeNow();

  String crateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeToJsonString(
      {required TmsTime that});

  String crateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeToSchema();

  String crateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeToString(
      {required TmsTime that});

  TmsTreeRole crateInfraTmsTreeRoleDefault();
  ...
  String crateInfraDatabaseSchemasTournamentErrorsTournamentErrorCodeGetMessage(
      {required TournamentErrorCode that});
  ...
  String crateInfraDatabaseSchemasTournamentErrorsTournamentErrorCodeToSchema();

  TournamentIntegrityCode
  ...
  String
      crateInfraDatabaseSchemasTournamentIntegrityMessageTournamentIntegrityCodeGetMessage(
          {required TournamentIntegrityCode that});
  ...
  String
      crateInfraDatabaseSchemasTournamentWarningsTournamentWarningCodeGetMessage(
          {required TournamentWarningCode that});
  ...
  FllBlueprint crateInfraFllInfraSeasonsFll2025UnearthedGetFllGame(
      {required Unearthed that});

  String crateInfraFllInfraSeasonsFll2025UnearthedGetSeason(
      {required Unearthed that});

  List<QuestionValidationError>
      crateInfraFllInfraSeasonsFll2025UnearthedValidate(
          {required Unearthed that,
          required Map<String, QuestionAnswer> answers});

  User crateInfraDatabaseSchemasUserUserDefault();

  User crateInfraDatabaseSchemasUserUserFromJsonString({required String json});

  UserPermissions crateInfraDatabaseSchemasUserUserGetPermissions(
      {required User that});
  ...
  String crateInfraNetworkSchemasUserRequestsUserInsertRequestToJsonString(
      {required UserInsertRequest that});

  String crateInfraNetworkSchemasUserRequestsUserInsertRequestToSchema();

  User crateInfraDatabaseSchemasUserUserNew(
      {required String username,
      required String password,
      required List<String> roles});

  UserPermissions crateInfraDatabaseSchemasUserUserPermissionsDefault();

  UserPermissions crateInfraDatabaseSchemasUserUserPermissionsFromJsonString(
      {required String json});

  UserPermissions crateInfraDatabaseSchemasUserUserPermissionsFromRoles(
      {required List<String> roles});
  ...
  List<String> crateInfraDatabaseSchemasUserUserPermissionsGetRoles(
      {required UserPermissions that});
  ...
  String crateInfraDatabaseSchemasUserUserPermissionsToJsonString(
      {required UserPermissions that});

  String crateInfraDatabaseSchemasUserUserPermissionsToSchema();
  ...
  String crateInfraNetworkSchemasUserRequestsUserRemoveRequestToJsonString(
      {required UserRemoveRequest that});

  String crateInfraNetworkSchemasUserRequestsUserRemoveRequestToSchema();
...
class TmsRustLibApiImpl extends TmsRustLibApiImplPlatform
  ...
  BackupGetNamesInfo
    ...
    return handler.executeSync(SyncTask(
      ...
      codec: SseCodec(
        decodeSuccessData: sse_decode_backup_get_names_info,
        decodeErrorData: null,
      ),
      constMeta:
          kCrateInfraNetworkSchemasBackupRequestsBackupGetNamesInfoDefaultConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraNetworkSchemasBackupRequestsBackupGetNamesInfoDefaultConstMeta =>
          const TaskConstMeta(
            debugName: "backup_get_names_info_default",
            argNames: [],
          );
  ...
  BackupGetNamesInfo
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraNetworkSchemasBackupRequestsBackupGetNamesInfoFromJsonStringConstMeta,
      argValues: [json],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraNetworkSchemasBackupRequestsBackupGetNamesInfoFromJsonStringConstMeta =>
          const TaskConstMeta(
            debugName: "backup_get_names_info_from_json_string",
            argNames: ["json"],
          );
  ...
  String crateInfraNetworkSchemasBackupRequestsBackupGetNamesInfoToJsonString(
    ...
    return handler.executeSync(SyncTask(
      callFfi: () {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_box_autoadd_backup_get_names_info(that, serializer);
      ...
      constMeta:
          kCrateInfraNetworkSchemasBackupRequestsBackupGetNamesInfoToJsonStringConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraNetworkSchemasBackupRequestsBackupGetNamesInfoToJsonStringConstMeta =>
          const TaskConstMeta(
            debugName: "backup_get_names_info_to_json_string",
            argNames: ["that"],
          );
  ...
  String crateInfraNetworkSchemasBackupRequestsBackupGetNamesInfoToSchema() {
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraNetworkSchemasBackupRequestsBackupGetNamesInfoToSchemaConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraNetworkSchemasBackupRequestsBackupGetNamesInfoToSchemaConstMeta =>
          const TaskConstMeta(
            debugName: "backup_get_names_info_to_schema",
            argNames: [],
          );
  ...
  BackupGetNamesResponse
    ...
    return handler.executeSync(SyncTask(
      ...
      codec: SseCodec(
        decodeSuccessData: sse_decode_backup_get_names_response,
        decodeErrorData: null,
      ),
      constMeta:
          kCrateInfraNetworkSchemasBackupRequestsBackupGetNamesResponseDefaultConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraNetworkSchemasBackupRequestsBackupGetNamesResponseDefaultConstMeta =>
          const TaskConstMeta(
            debugName: "backup_get_names_response_default",
            argNames: [],
          );
  ...
  BackupGetNamesResponse
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraNetworkSchemasBackupRequestsBackupGetNamesResponseFromJsonStringConstMeta,
      argValues: [json],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraNetworkSchemasBackupRequestsBackupGetNamesResponseFromJsonStringConstMeta =>
          const TaskConstMeta(
            debugName: "backup_get_names_response_from_json_string",
            argNames: ["json"],
          );
  ...
  String
    ...
    return handler.executeSync(SyncTask(
      callFfi: () {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_box_autoadd_backup_get_names_response(that, serializer);
      ...
      constMeta:
          kCrateInfraNetworkSchemasBackupRequestsBackupGetNamesResponseToJsonStringConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraNetworkSchemasBackupRequestsBackupGetNamesResponseToJsonStringConstMeta =>
          const TaskConstMeta(
            debugName: "backup_get_names_response_to_json_string",
            argNames: ["that"],
          );
  ...
  String
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraNetworkSchemasBackupRequestsBackupGetNamesResponseToSchemaConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraNetworkSchemasBackupRequestsBackupGetNamesResponseToSchemaConstMeta =>
          const TaskConstMeta(
            debugName: "backup_get_names_response_to_schema",
            argNames: [],
          );
  ...
  BackupRestoreRequest
    ...
    return handler.executeSync(SyncTask(
      ...
      codec: SseCodec(
        decodeSuccessData: sse_decode_backup_restore_request,
        decodeErrorData: null,
      ),
      constMeta:
          kCrateInfraNetworkSchemasBackupRequestsBackupRestoreRequestDefaultConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraNetworkSchemasBackupRequestsBackupRestoreRequestDefaultConstMeta =>
          const TaskConstMeta(
            debugName: "backup_restore_request_default",
            argNames: [],
          );
  ...
  BackupRestoreRequest
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraNetworkSchemasBackupRequestsBackupRestoreRequestFromJsonStringConstMeta,
      argValues: [json],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraNetworkSchemasBackupRequestsBackupRestoreRequestFromJsonStringConstMeta =>
          const TaskConstMeta(
            debugName: "backup_restore_request_from_json_string",
            argNames: ["json"],
          );
  ...
  String crateInfraNetworkSchemasBackupRequestsBackupRestoreRequestToJsonString(
    ...
    return handler.executeSync(SyncTask(
      callFfi: () {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_box_autoadd_backup_restore_request(that, serializer);
      ...
      constMeta:
          kCrateInfraNetworkSchemasBackupRequestsBackupRestoreRequestToJsonStringConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraNetworkSchemasBackupRequestsBackupRestoreRequestToJsonStringConstMeta =>
          const TaskConstMeta(
            debugName: "backup_restore_request_to_json_string",
            argNames: ["that"],
          );
  ...
  String crateInfraNetworkSchemasBackupRequestsBackupRestoreRequestToSchema() {
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraNetworkSchemasBackupRequestsBackupRestoreRequestToSchemaConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraNetworkSchemasBackupRequestsBackupRestoreRequestToSchemaConstMeta =>
          const TaskConstMeta(
            debugName: "backup_restore_request_to_schema",
            argNames: [],
          );
  ...
  FllBlueprint? crateInfraFllInfraFllBlueprintMapFllBlueprintMapGetFllBlueprint(
    ...
    return handler.executeSync(SyncTask(
      ...
      codec: SseCodec(
        decodeSuccessData: sse_decode_opt_box_autoadd_fll_blueprint,
        decodeErrorData: null,
      ),
      constMeta:
          kCrateInfraFllInfraFllBlueprintMapFllBlueprintMapGetFllBlueprintConstMeta,
      argValues: [season],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraFllInfraFllBlueprintMapFllBlueprintMapGetFllBlueprintConstMeta =>
          const TaskConstMeta(
            debugName: "fll_blueprint_map_get_fll_blueprint",
            argNames: ["season"],
          );
  ...
  List<String> crateInfraFllInfraFllBlueprintMapFllBlueprintMapGetSeasons() {
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraFllInfraFllBlueprintMapFllBlueprintMapGetSeasonsConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraFllInfraFllBlueprintMapFllBlueprintMapGetSeasonsConstMeta =>
          const TaskConstMeta(
            debugName: "fll_blueprint_map_get_seasons",
            argNames: [],
          );
  ...
  JudgingSessionPod
    ...
    return handler.executeSync(SyncTask(
      ...
      codec: SseCodec(
        decodeSuccessData: sse_decode_judging_session_pod,
        decodeErrorData: null,
      ),
      constMeta:
          kCrateInfraDatabaseSchemasJudgingSessionJudgingSessionPodDefaultConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasJudgingSessionJudgingSessionPodDefaultConstMeta =>
          const TaskConstMeta(
            debugName: "judging_session_pod_default",
            argNames: [],
          );
  ...
  JudgingSessionPod
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasJudgingSessionJudgingSessionPodFromJsonStringConstMeta,
      argValues: [json],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasJudgingSessionJudgingSessionPodFromJsonStringConstMeta =>
          const TaskConstMeta(
            debugName: "judging_session_pod_from_json_string",
            argNames: ["json"],
          );
  ...
  String crateInfraDatabaseSchemasJudgingSessionJudgingSessionPodToJsonString(
    ...
    return handler.executeSync(SyncTask(
      callFfi: () {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_box_autoadd_judging_session_pod(that, serializer);
      ...
      constMeta:
          kCrateInfraDatabaseSchemasJudgingSessionJudgingSessionPodToJsonStringConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasJudgingSessionJudgingSessionPodToJsonStringConstMeta =>
          const TaskConstMeta(
            debugName: "judging_session_pod_to_json_string",
            argNames: ["that"],
          );
  ...
  String crateInfraDatabaseSchemasJudgingSessionJudgingSessionPodToSchema() {
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasJudgingSessionJudgingSessionPodToSchemaConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasJudgingSessionJudgingSessionPodToSchemaConstMeta =>
          const TaskConstMeta(
            debugName: "judging_session_pod_to_schema",
            argNames: [],
          );
  ...
  List<QuestionValidationError>
    ...
    return handler.executeSync(SyncTask(
      callFfi: () {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_box_autoadd_master_piece(that, serializer);
        sse_encode_Map_String_question_answer_None(answers, serializer);
  ...
  RobotGameToggleTeamCheckInRequest
    ...
    return handler.executeSync(SyncTask(
      ...
      codec: SseCodec(
        decodeSuccessData: sse_decode_robot_game_toggle_team_check_in_request,
        decodeErrorData: null,
      ),
      constMeta:
          kCrateInfraNetworkSchemasRobotGameMatchRequestsRobotGameToggleTeamCheckInRequestDefaultConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraNetworkSchemasRobotGameMatchRequestsRobotGameToggleTeamCheckInRequestDefaultConstMeta =>
          const TaskConstMeta(
            debugName: "robot_game_toggle_team_check_in_request_default",
            argNames: [],
          );
  ...
  RobotGameToggleTeamCheckInRequest
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraNetworkSchemasRobotGameMatchRequestsRobotGameToggleTeamCheckInRequestFromJsonStringConstMeta,
      argValues: [json],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraNetworkSchemasRobotGameMatchRequestsRobotGameToggleTeamCheckInRequestFromJsonStringConstMeta =>
          const TaskConstMeta(
            debugName:
                "robot_game_toggle_team_check_in_request_from_json_string",
            argNames: ["json"],
          );
  ...
  String
    ...
    return handler.executeSync(SyncTask(
      callFfi: () {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_box_autoadd_robot_game_toggle_team_check_in_request(
            that, serializer);
      ...
      constMeta:
          kCrateInfraNetworkSchemasRobotGameMatchRequestsRobotGameToggleTeamCheckInRequestToJsonStringConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraNetworkSchemasRobotGameMatchRequestsRobotGameToggleTeamCheckInRequestToJsonStringConstMeta =>
          const TaskConstMeta(
            debugName: "robot_game_toggle_team_check_in_request_to_json_string",
            argNames: ["that"],
          );
  ...
  String
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraNetworkSchemasRobotGameMatchRequestsRobotGameToggleTeamCheckInRequestToSchemaConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraNetworkSchemasRobotGameMatchRequestsRobotGameToggleTeamCheckInRequestToSchemaConstMeta =>
          const TaskConstMeta(
            debugName: "robot_game_toggle_team_check_in_request_to_schema",
            argNames: [],
          );
  ...
  FllBlueprint crateInfraFllInfraSeasonsFll2024SubmergedGetFllGame(
    ...
    return handler.executeSync(SyncTask(
      callFfi: () {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_box_autoadd_submerged(that, serializer);
      ...
      constMeta: kCrateInfraFllInfraSeasonsFll2024SubmergedGetFllGameConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraFllInfraSeasonsFll2024SubmergedGetFllGameConstMeta =>
          const TaskConstMeta(
            debugName: "submerged_get_fll_game",
            argNames: ["that"],
          );
  ...
  String crateInfraFllInfraSeasonsFll2024SubmergedGetSeason(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateInfraFllInfraSeasonsFll2024SubmergedGetSeasonConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraFllInfraSeasonsFll2024SubmergedGetSeasonConstMeta =>
          const TaskConstMeta(
            debugName: "submerged_get_season",
            argNames: ["that"],
          );
  ...
  List<QuestionValidationError>
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateInfraFllInfraSeasonsFll2024SubmergedValidateConstMeta,
      argValues: [that, answers],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraFllInfraSeasonsFll2024SubmergedValidateConstMeta =>
          const TaskConstMeta(
            debugName: "submerged_validate",
            argNames: ["that", "answers"],
          );
  ...
  TmsCategory crateInfraDatabaseSchemasCategoryTmsCategoryDefault() {
    return handler.executeSync(SyncTask(
      ...
      codec: SseCodec(
        decodeSuccessData: sse_decode_tms_category,
        decodeErrorData: null,
      ),
      constMeta: kCrateInfraDatabaseSchemasCategoryTmsCategoryDefaultConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasCategoryTmsCategoryDefaultConstMeta =>
          const TaskConstMeta(
            debugName: "tms_category_default",
            argNames: [],
          );
  ...
  TmsCategory crateInfraDatabaseSchemasCategoryTmsCategoryFromJsonString(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasCategoryTmsCategoryFromJsonStringConstMeta,
      argValues: [json],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasCategoryTmsCategoryFromJsonStringConstMeta =>
          const TaskConstMeta(
            debugName: "tms_category_from_json_string",
            argNames: ["json"],
          );
  ...
  String crateInfraDatabaseSchemasCategoryTmsCategoryToJsonString(
    ...
    return handler.executeSync(SyncTask(
      callFfi: () {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_box_autoadd_tms_category(that, serializer);
      ...
      constMeta:
          kCrateInfraDatabaseSchemasCategoryTmsCategoryToJsonStringConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasCategoryTmsCategoryToJsonStringConstMeta =>
          const TaskConstMeta(
            debugName: "tms_category_to_json_string",
            argNames: ["that"],
          );
  ...
  String crateInfraDatabaseSchemasCategoryTmsCategoryToSchema() {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateInfraDatabaseSchemasCategoryTmsCategoryToSchemaConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasCategoryTmsCategoryToSchemaConstMeta =>
          const TaskConstMeta(
            debugName: "tms_category_to_schema",
            argNames: [],
          );
  ...
  int crateInfraDatabaseSchemasTmsTimeTmsDateTmsDateCompareTo(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTmsTimeTmsDateTmsDateCompareToConstMeta,
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsDateTmsDateCompareToConstMeta =>
          const TaskConstMeta(
            debugName: "tms_date_compare_to",
            argNames: ["that", "other"],
          );
  ...
  TmsDate crateInfraDatabaseSchemasTmsTimeTmsDateTmsDateDefault() {
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTmsTimeTmsDateTmsDateDefaultConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsDateTmsDateDefaultConstMeta =>
          const TaskConstMeta(
            debugName: "tms_date_default",
            argNames: [],
          );
  ...
  TmsDuration crateInfraDatabaseSchemasTmsTimeTmsDateTmsDateDifference(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTmsTimeTmsDateTmsDateDifferenceConstMeta,
      argValues: [that, other],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsDateTmsDateDifferenceConstMeta =>
          const TaskConstMeta(
            debugName: "tms_date_difference",
            argNames: ["that", "other"],
          );
  ...
  TmsDuration crateInfraDatabaseSchemasTmsTimeTmsDateTmsDateDuration(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTmsTimeTmsDateTmsDateDurationConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsDateTmsDateDurationConstMeta =>
          const TaskConstMeta(
            debugName: "tms_date_duration",
            argNames: ["that"],
          );
  ...
  TmsDate crateInfraDatabaseSchemasTmsTimeTmsDateTmsDateFromJsonString(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTmsTimeTmsDateTmsDateFromJsonStringConstMeta,
      argValues: [json],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsDateTmsDateFromJsonStringConstMeta =>
          const TaskConstMeta(
            debugName: "tms_date_from_json_string",
            argNames: ["json"],
          );
  ...
  bool crateInfraDatabaseSchemasTmsTimeTmsDateTmsDateIsAfter(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTmsTimeTmsDateTmsDateIsAfterConstMeta,
      argValues: [that, other],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsDateTmsDateIsAfterConstMeta =>
          const TaskConstMeta(
            debugName: "tms_date_is_after",
            argNames: ["that", "other"],
          );
  ...
  bool crateInfraDatabaseSchemasTmsTimeTmsDateTmsDateIsBefore(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTmsTimeTmsDateTmsDateIsBeforeConstMeta,
      argValues: [that, other],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsDateTmsDateIsBeforeConstMeta =>
          const TaskConstMeta(
            debugName: "tms_date_is_before",
            argNames: ["that", "other"],
          );
  ...
  bool crateInfraDatabaseSchemasTmsTimeTmsDateTmsDateIsSameMoment(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTmsTimeTmsDateTmsDateIsSameMomentConstMeta,
      argValues: [that, other],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsDateTmsDateIsSameMomentConstMeta =>
          const TaskConstMeta(
            debugName: "tms_date_is_same_moment",
            argNames: ["that", "other"],
          );
  ...
  TmsDate crateInfraDatabaseSchemasTmsTimeTmsDateTmsDateNew(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateInfraDatabaseSchemasTmsTimeTmsDateTmsDateNewConstMeta,
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsDateTmsDateNewConstMeta =>
          const TaskConstMeta(
  ...
  TmsDate crateInfraDatabaseSchemasTmsTimeTmsDateTmsDateNow() {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateInfraDatabaseSchemasTmsTimeTmsDateTmsDateNowConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsDateTmsDateNowConstMeta =>
          const TaskConstMeta(
  ...
  int crateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeCompareTo(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeCompareToConstMeta,
      argValues: [that, other],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeCompareToConstMeta =>
          const TaskConstMeta(
            debugName: "tms_date_time_compare_to",
            argNames: ["that", "other"],
          );
  ...
  TmsDateTime crateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeDefault() {
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeDefaultConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeDefaultConstMeta =>
          const TaskConstMeta(
  ...
  TmsDuration crateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeDifference(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeDifferenceConstMeta,
      argValues: [that, other],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeDifferenceConstMeta =>
          const TaskConstMeta(
            debugName: "tms_date_time_difference",
            argNames: ["that", "other"],
          );
  ...
  TmsDuration crateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeDuration(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeDurationConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeDurationConstMeta =>
          const TaskConstMeta(
            debugName: "tms_date_time_duration",
            argNames: ["that"],
          );
  ...
  TmsDateTime
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeFromJsonStringConstMeta,
      argValues: [json],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeFromJsonStringConstMeta =>
          const TaskConstMeta(
  ...
  bool crateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeIsAfter(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeIsAfterConstMeta,
      argValues: [that, other],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeIsAfterConstMeta =>
          const TaskConstMeta(
            debugName: "tms_date_time_is_after",
            argNames: ["that", "other"],
          );
  ...
  bool crateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeIsBefore(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeIsBeforeConstMeta,
      argValues: [that, other],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeIsBeforeConstMeta =>
          const TaskConstMeta(
            debugName: "tms_date_time_is_before",
            argNames: ["that", "other"],
          );
  ...
  bool crateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeIsSameMoment(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeIsSameMomentConstMeta,
      argValues: [that, other],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeIsSameMomentConstMeta =>
          const TaskConstMeta(
            debugName: "tms_date_time_is_same_moment",
            argNames: ["that", "other"],
          );
  ...
  TmsDateTime crateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeNew(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeNewConstMeta,
      argValues: [date, time],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeNewConstMeta =>
          const TaskConstMeta(
  ...
  TmsDateTime crateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeNow() {
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeNowConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeNowConstMeta =>
          const TaskConstMeta(
  ...
  String crateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeToJsonString(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeToJsonStringConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeToJsonStringConstMeta =>
          const TaskConstMeta(
  ...
  String crateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeToSchema() {
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeToSchemaConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeToSchemaConstMeta =>
          const TaskConstMeta(
  ...
  String crateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeToString(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeToStringConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsDateTimeTmsDateTimeToStringConstMeta =>
          const TaskConstMeta(
            debugName: "tms_date_time_to_string",
            argNames: ["that"],
          );
  ...
  String crateInfraDatabaseSchemasTmsTimeTmsDateTmsDateToJsonString(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTmsTimeTmsDateTmsDateToJsonStringConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsDateTmsDateToJsonStringConstMeta =>
          const TaskConstMeta(
            debugName: "tms_date_to_json_string",
            argNames: ["that"],
          );
  ...
  String crateInfraDatabaseSchemasTmsTimeTmsDateTmsDateToSchema() {
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTmsTimeTmsDateTmsDateToSchemaConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsDateTmsDateToSchemaConstMeta =>
          const TaskConstMeta(
            debugName: "tms_date_to_schema",
            argNames: [],
          );
  ...
  String crateInfraDatabaseSchemasTmsTimeTmsDateTmsDateToString(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTmsTimeTmsDateTmsDateToStringConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsDateTmsDateToStringConstMeta =>
          const TaskConstMeta(
            debugName: "tms_date_to_string",
            argNames: ["that"],
          );
  ...
  TmsDuration crateInfraDatabaseSchemasTmsTimeTmsDurationTmsDurationDifference(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTmsTimeTmsDurationTmsDurationDifferenceConstMeta,
      argValues: [that, other],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsDurationTmsDurationDifferenceConstMeta =>
          const TaskConstMeta(
            debugName: "tms_duration_difference",
            argNames: ["that", "other"],
          );
  ...
  int crateInfraDatabaseSchemasTmsTimeTmsDurationTmsDurationInDays(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTmsTimeTmsDurationTmsDurationInDaysConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsDurationTmsDurationInDaysConstMeta =>
          const TaskConstMeta(
            debugName: "tms_duration_in_days",
            argNames: ["that"],
          );
  ...
  int crateInfraDatabaseSchemasTmsTimeTmsDurationTmsDurationInHours(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTmsTimeTmsDurationTmsDurationInHoursConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsDurationTmsDurationInHoursConstMeta =>
          const TaskConstMeta(
            debugName: "tms_duration_in_hours",
            argNames: ["that"],
          );
  ...
  int crateInfraDatabaseSchemasTmsTimeTmsDurationTmsDurationInMinutes(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTmsTimeTmsDurationTmsDurationInMinutesConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsDurationTmsDurationInMinutesConstMeta =>
          const TaskConstMeta(
            debugName: "tms_duration_in_minutes",
            argNames: ["that"],
          );
  ...
  int crateInfraDatabaseSchemasTmsTimeTmsDurationTmsDurationInMonths(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTmsTimeTmsDurationTmsDurationInMonthsConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsDurationTmsDurationInMonthsConstMeta =>
          const TaskConstMeta(
            debugName: "tms_duration_in_months",
            argNames: ["that"],
          );
  ...
  int crateInfraDatabaseSchemasTmsTimeTmsDurationTmsDurationInSeconds(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTmsTimeTmsDurationTmsDurationInSecondsConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsDurationTmsDurationInSecondsConstMeta =>
          const TaskConstMeta(
            debugName: "tms_duration_in_seconds",
            argNames: ["that"],
          );
  ...
  int crateInfraDatabaseSchemasTmsTimeTmsDurationTmsDurationInYears(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTmsTimeTmsDurationTmsDurationInYearsConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsDurationTmsDurationInYearsConstMeta =>
          const TaskConstMeta(
            debugName: "tms_duration_in_years",
            argNames: ["that"],
          );
  ...
  TmsDuration crateInfraDatabaseSchemasTmsTimeTmsDurationTmsDurationNew(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTmsTimeTmsDurationTmsDurationNewConstMeta,
      argValues: [years, months, days, hours, minutes, seconds],
      apiImpl: this,
    ));
  }

  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsDurationTmsDurationNewConstMeta =>
          const TaskConstMeta(
            debugName: "tms_duration_new",
            argNames: [
              "years",
              "months",
              "days",
  ...
  int crateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeCompareTo(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeCompareToConstMeta,
      argValues: [that, other],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeCompareToConstMeta =>
          const TaskConstMeta(
            debugName: "tms_time_compare_to",
            argNames: ["that", "other"],
          );
  ...
  TmsTime crateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeDefault() {
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeDefaultConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeDefaultConstMeta =>
          const TaskConstMeta(
            debugName: "tms_time_default",
            argNames: [],
          );
  ...
  TmsDuration crateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeDifference(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeDifferenceConstMeta,
      argValues: [that, other],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeDifferenceConstMeta =>
          const TaskConstMeta(
            debugName: "tms_time_difference",
            argNames: ["that", "other"],
          );
  ...
  TmsDuration crateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeDuration(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeDurationConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeDurationConstMeta =>
          const TaskConstMeta(
            debugName: "tms_time_duration",
            argNames: ["that"],
          );
  ...
  TmsTime crateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeFromJsonString(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeFromJsonStringConstMeta,
      argValues: [json],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeFromJsonStringConstMeta =>
          const TaskConstMeta(
            debugName: "tms_time_from_json_string",
            argNames: ["json"],
          );
  ...
  bool crateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeIsAfter(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeIsAfterConstMeta,
      argValues: [that, other],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeIsAfterConstMeta =>
          const TaskConstMeta(
            debugName: "tms_time_is_after",
            argNames: ["that", "other"],
          );
  ...
  bool crateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeIsBefore(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeIsBeforeConstMeta,
      argValues: [that, other],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeIsBeforeConstMeta =>
          const TaskConstMeta(
            debugName: "tms_time_is_before",
            argNames: ["that", "other"],
          );
  ...
  bool crateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeIsSameMoment(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeIsSameMomentConstMeta,
      argValues: [that, other],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeIsSameMomentConstMeta =>
          const TaskConstMeta(
            debugName: "tms_time_is_same_moment",
            argNames: ["that", "other"],
          );
  ...
  TmsTime crateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeNew(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeNewConstMeta,
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeNewConstMeta =>
          const TaskConstMeta(
  ...
  TmsTime crateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeNow() {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeNowConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeNowConstMeta =>
          const TaskConstMeta(
  ...
  String crateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeToJsonString(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeToJsonStringConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeToJsonStringConstMeta =>
          const TaskConstMeta(
            debugName: "tms_time_to_json_string",
            argNames: ["that"],
          );
  ...
  String crateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeToSchema() {
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeToSchemaConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeToSchemaConstMeta =>
          const TaskConstMeta(
            debugName: "tms_time_to_schema",
            argNames: [],
          );
  ...
  String crateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeToString(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeToStringConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTmsTimeTmsTimeTmsTimeToStringConstMeta =>
          const TaskConstMeta(
            debugName: "tms_time_to_string",
            argNames: ["that"],
          );
  ...
  TournamentErrorCode
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTournamentErrorsTournamentErrorCodeDefaultConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTournamentErrorsTournamentErrorCodeDefaultConstMeta =>
          const TaskConstMeta(
            debugName: "tournament_error_code_default",
            argNames: [],
          );
  ...
  TournamentErrorCode
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTournamentErrorsTournamentErrorCodeFromJsonStringConstMeta,
      argValues: [json],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTournamentErrorsTournamentErrorCodeFromJsonStringConstMeta =>
          const TaskConstMeta(
            debugName: "tournament_error_code_from_json_string",
            argNames: ["json"],
          );
  ...
  String crateInfraDatabaseSchemasTournamentErrorsTournamentErrorCodeGetMessage(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTournamentErrorsTournamentErrorCodeGetMessageConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTournamentErrorsTournamentErrorCodeGetMessageConstMeta =>
          const TaskConstMeta(
            debugName: "tournament_error_code_get_message",
            argNames: ["that"],
          );
  ...
  String
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTournamentErrorsTournamentErrorCodeGetStringifiedCodeConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTournamentErrorsTournamentErrorCodeGetStringifiedCodeConstMeta =>
          const TaskConstMeta(
            debugName: "tournament_error_code_get_stringified_code",
            argNames: ["that"],
          );
  ...
  String
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTournamentErrorsTournamentErrorCodeToJsonStringConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTournamentErrorsTournamentErrorCodeToJsonStringConstMeta =>
          const TaskConstMeta(
            debugName: "tournament_error_code_to_json_string",
            argNames: ["that"],
          );
  ...
  String
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTournamentErrorsTournamentErrorCodeToSchemaConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTournamentErrorsTournamentErrorCodeToSchemaConstMeta =>
          const TaskConstMeta(
            debugName: "tournament_error_code_to_schema",
            argNames: [],
          );
  ...
  TournamentIntegrityCode
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTournamentIntegrityMessageTournamentIntegrityCodeDefaultConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTournamentIntegrityMessageTournamentIntegrityCodeDefaultConstMeta =>
          const TaskConstMeta(
            debugName: "tournament_integrity_code_default",
            argNames: [],
          );
  ...
  TournamentIntegrityCode
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTournamentIntegrityMessageTournamentIntegrityCodeFromJsonStringConstMeta,
      argValues: [json],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTournamentIntegrityMessageTournamentIntegrityCodeFromJsonStringConstMeta =>
          const TaskConstMeta(
            debugName: "tournament_integrity_code_from_json_string",
            argNames: ["json"],
          );
  ...
  String
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTournamentIntegrityMessageTournamentIntegrityCodeGetMessageConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTournamentIntegrityMessageTournamentIntegrityCodeGetMessageConstMeta =>
          const TaskConstMeta(
            debugName: "tournament_integrity_code_get_message",
            argNames: ["that"],
          );
  ...
  String
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTournamentIntegrityMessageTournamentIntegrityCodeGetStringifiedCodeConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTournamentIntegrityMessageTournamentIntegrityCodeGetStringifiedCodeConstMeta =>
          const TaskConstMeta(
            debugName: "tournament_integrity_code_get_stringified_code",
            argNames: ["that"],
          );
  ...
  String
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTournamentIntegrityMessageTournamentIntegrityCodeToJsonStringConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTournamentIntegrityMessageTournamentIntegrityCodeToJsonStringConstMeta =>
          const TaskConstMeta(
            debugName: "tournament_integrity_code_to_json_string",
            argNames: ["that"],
          );
  ...
  String
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTournamentIntegrityMessageTournamentIntegrityCodeToSchemaConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTournamentIntegrityMessageTournamentIntegrityCodeToSchemaConstMeta =>
          const TaskConstMeta(
            debugName: "tournament_integrity_code_to_schema",
            argNames: [],
          );
  ...
  TournamentIntegrityMessage
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTournamentIntegrityMessageTournamentIntegrityMessageDefaultConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTournamentIntegrityMessageTournamentIntegrityMessageDefaultConstMeta =>
          const TaskConstMeta(
            debugName: "tournament_integrity_message_default",
            argNames: [],
          );
  ...
  TournamentIntegrityMessage
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTournamentIntegrityMessageTournamentIntegrityMessageFromJsonStringConstMeta,
      argValues: [json],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTournamentIntegrityMessageTournamentIntegrityMessageFromJsonStringConstMeta =>
          const TaskConstMeta(
            debugName: "tournament_integrity_message_from_json_string",
            argNames: ["json"],
          );
  ...
  TournamentIntegrityMessage
    ...
    return handler.executeSync(SyncTask(
      callFfi: () {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_box_autoadd_tournament_integrity_code(
            integrityCode, serializer);
        sse_encode_opt_String(teamNumber, serializer);
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTournamentIntegrityMessageTournamentIntegrityMessageNewConstMeta,
      argValues: [integrityCode, teamNumber, matchNumber, sessionNumber],
      apiImpl: this,
    ));
  }

  TaskConstMeta
      get kCrateInfraDatabaseSchemasTournamentIntegrityMessageTournamentIntegrityMessageNewConstMeta =>
          const TaskConstMeta(
            debugName: "tournament_integrity_message_new",
            argNames: [
              "integrityCode",
              "teamNumber",
              "matchNumber",
  ...
  String
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTournamentIntegrityMessageTournamentIntegrityMessageToJsonStringConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTournamentIntegrityMessageTournamentIntegrityMessageToJsonStringConstMeta =>
          const TaskConstMeta(
            debugName: "tournament_integrity_message_to_json_string",
            argNames: ["that"],
          );
  ...
  String
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTournamentIntegrityMessageTournamentIntegrityMessageToSchemaConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTournamentIntegrityMessageTournamentIntegrityMessageToSchemaConstMeta =>
          const TaskConstMeta(
            debugName: "tournament_integrity_message_to_schema",
            argNames: [],
          );
  ...
  TournamentSeasonBlueprint
    ...
    return handler.executeSync(SyncTask(
      ...
      codec: SseCodec(
        decodeSuccessData: sse_decode_tournament_season_blueprint,
        decodeErrorData: null,
      ),
      constMeta:
          kCrateInfraDatabaseSchemasTournamentSeasonBlueprintTournamentSeasonBlueprintDefaultConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTournamentSeasonBlueprintTournamentSeasonBlueprintDefaultConstMeta =>
          const TaskConstMeta(
            debugName: "tournament_season_blueprint_default",
            argNames: [],
          );
  ...
  TournamentSeasonBlueprint
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTournamentSeasonBlueprintTournamentSeasonBlueprintFromJsonStringConstMeta,
      argValues: [json],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTournamentSeasonBlueprintTournamentSeasonBlueprintFromJsonStringConstMeta =>
          const TaskConstMeta(
            debugName: "tournament_season_blueprint_from_json_string",
            argNames: ["json"],
          );
  ...
  String
    ...
    return handler.executeSync(SyncTask(
      callFfi: () {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_box_autoadd_tournament_season_blueprint(that, serializer);
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTournamentSeasonBlueprintTournamentSeasonBlueprintToJsonStringConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTournamentSeasonBlueprintTournamentSeasonBlueprintToJsonStringConstMeta =>
          const TaskConstMeta(
            debugName: "tournament_season_blueprint_to_json_string",
            argNames: ["that"],
          );
  ...
  String
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTournamentSeasonBlueprintTournamentSeasonBlueprintToSchemaConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTournamentSeasonBlueprintTournamentSeasonBlueprintToSchemaConstMeta =>
          const TaskConstMeta(
            debugName: "tournament_season_blueprint_to_schema",
            argNames: [],
          );
  ...
  TournamentWarningCode
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTournamentWarningsTournamentWarningCodeDefaultConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTournamentWarningsTournamentWarningCodeDefaultConstMeta =>
          const TaskConstMeta(
            debugName: "tournament_warning_code_default",
            argNames: [],
          );
  ...
  TournamentWarningCode
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTournamentWarningsTournamentWarningCodeFromJsonStringConstMeta,
      argValues: [json],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTournamentWarningsTournamentWarningCodeFromJsonStringConstMeta =>
          const TaskConstMeta(
            debugName: "tournament_warning_code_from_json_string",
            argNames: ["json"],
          );
  ...
  String
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTournamentWarningsTournamentWarningCodeGetMessageConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTournamentWarningsTournamentWarningCodeGetMessageConstMeta =>
          const TaskConstMeta(
            debugName: "tournament_warning_code_get_message",
            argNames: ["that"],
          );
  ...
  String
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTournamentWarningsTournamentWarningCodeGetStringifiedCodeConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTournamentWarningsTournamentWarningCodeGetStringifiedCodeConstMeta =>
          const TaskConstMeta(
            debugName: "tournament_warning_code_get_stringified_code",
            argNames: ["that"],
          );
  ...
  String
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTournamentWarningsTournamentWarningCodeToJsonStringConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTournamentWarningsTournamentWarningCodeToJsonStringConstMeta =>
          const TaskConstMeta(
            debugName: "tournament_warning_code_to_json_string",
            argNames: ["that"],
          );
  ...
  String
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasTournamentWarningsTournamentWarningCodeToSchemaConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasTournamentWarningsTournamentWarningCodeToSchemaConstMeta =>
          const TaskConstMeta(
            debugName: "tournament_warning_code_to_schema",
            argNames: [],
          );
  ...
  FllBlueprint crateInfraFllInfraSeasonsFll2025UnearthedGetFllGame(
    ...
    return handler.executeSync(SyncTask(
      callFfi: () {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_box_autoadd_unearthed(that, serializer);
      ...
      constMeta: kCrateInfraFllInfraSeasonsFll2025UnearthedGetFllGameConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraFllInfraSeasonsFll2025UnearthedGetFllGameConstMeta =>
          const TaskConstMeta(
            debugName: "unearthed_get_fll_game",
            argNames: ["that"],
          );
  ...
  String crateInfraFllInfraSeasonsFll2025UnearthedGetSeason(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateInfraFllInfraSeasonsFll2025UnearthedGetSeasonConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraFllInfraSeasonsFll2025UnearthedGetSeasonConstMeta =>
          const TaskConstMeta(
            debugName: "unearthed_get_season",
            argNames: ["that"],
          );
  ...
  List<QuestionValidationError>
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateInfraFllInfraSeasonsFll2025UnearthedValidateConstMeta,
      argValues: [that, answers],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraFllInfraSeasonsFll2025UnearthedValidateConstMeta =>
          const TaskConstMeta(
            debugName: "unearthed_validate",
            argNames: ["that", "answers"],
          );
  ...
  UserPermissions crateInfraDatabaseSchemasUserUserGetPermissions(
    ...
    return handler.executeSync(SyncTask(
      ...
      codec: SseCodec(
        decodeSuccessData: sse_decode_user_permissions,
        decodeErrorData: null,
      ),
      constMeta: kCrateInfraDatabaseSchemasUserUserGetPermissionsConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateInfraDatabaseSchemasUserUserGetPermissionsConstMeta =>
      const TaskConstMeta(
        debugName: "user_get_permissions",
        argNames: ["that"],
      );
  ...
  bool crateInfraDatabaseSchemasUserUserHasRole(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateInfraDatabaseSchemasUserUserHasRoleConstMeta,
      argValues: [that, role],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateInfraDatabaseSchemasUserUserHasRoleConstMeta =>
      const TaskConstMeta(
        debugName: "user_has_role",
        argNames: ["that", "role"],
      );
  ...
  UserInsertRequest
    ...
    return handler.executeSync(SyncTask(
      ...
      codec: SseCodec(
        decodeSuccessData: sse_decode_user_insert_request,
        decodeErrorData: null,
      ),
      constMeta:
          kCrateInfraNetworkSchemasUserRequestsUserInsertRequestDefaultConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraNetworkSchemasUserRequestsUserInsertRequestDefaultConstMeta =>
          const TaskConstMeta(
            debugName: "user_insert_request_default",
            argNames: [],
          );
  ...
  UserInsertRequest
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraNetworkSchemasUserRequestsUserInsertRequestFromJsonStringConstMeta,
      argValues: [json],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraNetworkSchemasUserRequestsUserInsertRequestFromJsonStringConstMeta =>
          const TaskConstMeta(
            debugName: "user_insert_request_from_json_string",
            argNames: ["json"],
          );
  ...
  String crateInfraNetworkSchemasUserRequestsUserInsertRequestToJsonString(
    ...
    return handler.executeSync(SyncTask(
      callFfi: () {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_box_autoadd_user_insert_request(that, serializer);
      ...
      constMeta:
          kCrateInfraNetworkSchemasUserRequestsUserInsertRequestToJsonStringConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraNetworkSchemasUserRequestsUserInsertRequestToJsonStringConstMeta =>
          const TaskConstMeta(
            debugName: "user_insert_request_to_json_string",
            argNames: ["that"],
          );
  ...
  String crateInfraNetworkSchemasUserRequestsUserInsertRequestToSchema() {
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraNetworkSchemasUserRequestsUserInsertRequestToSchemaConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraNetworkSchemasUserRequestsUserInsertRequestToSchemaConstMeta =>
          const TaskConstMeta(
            debugName: "user_insert_request_to_schema",
            argNames: [],
          );
  ...
  User crateInfraDatabaseSchemasUserUserNew(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateInfraDatabaseSchemasUserUserNewConstMeta,
      argValues: [username, password, roles],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateInfraDatabaseSchemasUserUserNewConstMeta =>
      const TaskConstMeta(
        debugName: "user_new",
        argNames: ["username", "password", "roles"],
      );
  ...
  UserPermissions crateInfraDatabaseSchemasUserUserPermissionsDefault() {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateInfraDatabaseSchemasUserUserPermissionsDefaultConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasUserUserPermissionsDefaultConstMeta =>
          const TaskConstMeta(
            debugName: "user_permissions_default",
            argNames: [],
          );
  ...
  UserPermissions crateInfraDatabaseSchemasUserUserPermissionsFromJsonString(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasUserUserPermissionsFromJsonStringConstMeta,
      argValues: [json],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasUserUserPermissionsFromJsonStringConstMeta =>
          const TaskConstMeta(
            debugName: "user_permissions_from_json_string",
            argNames: ["json"],
          );
  ...
  UserPermissions crateInfraDatabaseSchemasUserUserPermissionsFromRoles(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasUserUserPermissionsFromRolesConstMeta,
      argValues: [roles],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasUserUserPermissionsFromRolesConstMeta =>
          const TaskConstMeta(
            debugName: "user_permissions_from_roles",
            argNames: ["roles"],
          );
  ...
  UserPermissions
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasUserUserPermissionsGetMergedPermissionsConstMeta,
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasUserUserPermissionsGetMergedPermissionsConstMeta =>
          const TaskConstMeta(
            debugName: "user_permissions_get_merged_permissions",
  ...
  List<String> crateInfraDatabaseSchemasUserUserPermissionsGetRoles(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateInfraDatabaseSchemasUserUserPermissionsGetRolesConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasUserUserPermissionsGetRolesConstMeta =>
          const TaskConstMeta(
            debugName: "user_permissions_get_roles",
            argNames: ["that"],
          );
  ...
  UserPermissions crateInfraDatabaseSchemasUserUserPermissionsNew(
    ...
    return handler.executeSync(SyncTask(
      callFfi: () {
        ...
        sse_encode_opt_box_autoadd_bool(judgeAdvisor, serializer);
        sse_encode_opt_box_autoadd_bool(scoreKeeper, serializer);
        sse_encode_opt_box_autoadd_bool(emcee, serializer);
        sse_encode_opt_box_autoadd_bool(av, serializer);
  ...
  TaskConstMeta get kCrateInfraDatabaseSchemasUserUserPermissionsNewConstMeta =>
      const TaskConstMeta(
  ...
  String crateInfraDatabaseSchemasUserUserPermissionsToJsonString(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraDatabaseSchemasUserUserPermissionsToJsonStringConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasUserUserPermissionsToJsonStringConstMeta =>
          const TaskConstMeta(
            debugName: "user_permissions_to_json_string",
            argNames: ["that"],
          );
  ...
  String crateInfraDatabaseSchemasUserUserPermissionsToSchema() {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateInfraDatabaseSchemasUserUserPermissionsToSchemaConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraDatabaseSchemasUserUserPermissionsToSchemaConstMeta =>
          const TaskConstMeta(
            debugName: "user_permissions_to_schema",
            argNames: [],
          );
  ...
  UserRemoveRequest
    ...
    return handler.executeSync(SyncTask(
      ...
      codec: SseCodec(
        decodeSuccessData: sse_decode_user_remove_request,
        decodeErrorData: null,
      ),
      constMeta:
          kCrateInfraNetworkSchemasUserRequestsUserRemoveRequestDefaultConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraNetworkSchemasUserRequestsUserRemoveRequestDefaultConstMeta =>
          const TaskConstMeta(
            debugName: "user_remove_request_default",
            argNames: [],
          );
  ...
  UserRemoveRequest
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraNetworkSchemasUserRequestsUserRemoveRequestFromJsonStringConstMeta,
      argValues: [json],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraNetworkSchemasUserRequestsUserRemoveRequestFromJsonStringConstMeta =>
          const TaskConstMeta(
            debugName: "user_remove_request_from_json_string",
            argNames: ["json"],
          );
  ...
  String crateInfraNetworkSchemasUserRequestsUserRemoveRequestToJsonString(
    ...
    return handler.executeSync(SyncTask(
      callFfi: () {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_box_autoadd_user_remove_request(that, serializer);
      ...
      constMeta:
          kCrateInfraNetworkSchemasUserRequestsUserRemoveRequestToJsonStringConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraNetworkSchemasUserRequestsUserRemoveRequestToJsonStringConstMeta =>
          const TaskConstMeta(
            debugName: "user_remove_request_to_json_string",
            argNames: ["that"],
          );
  ...
  String crateInfraNetworkSchemasUserRequestsUserRemoveRequestToSchema() {
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateInfraNetworkSchemasUserRequestsUserRemoveRequestToSchemaConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateInfraNetworkSchemasUserRequestsUserRemoveRequestToSchemaConstMeta =>
          const TaskConstMeta(
            debugName: "user_remove_request_to_schema",
            argNames: [],
          );
  ...
  BackupGetNamesInfo dco_decode_backup_get_names_info(dynamic raw) {
    ...
    return BackupGetNamesInfo(
      fileName: dco_decode_String(arr[0]),
      timestamp: dco_decode_tms_date_time(arr[1]),
    );
  }
  ...
  BackupGetNamesResponse dco_decode_backup_get_names_response(dynamic raw) {
    ...
    return BackupGetNamesResponse(
      backups: dco_decode_list_backup_get_names_info(arr[0]),
    );
  }
  ...
  BackupGetNamesInfo dco_decode_box_autoadd_backup_get_names_info(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_backup_get_names_info(raw);
  }
  ...
  BackupGetNamesResponse dco_decode_box_autoadd_backup_get_names_response(
      dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_backup_get_names_response(raw);
  }
  ...
  BackupRestoreRequest dco_decode_box_autoadd_backup_restore_request(
      dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_backup_restore_request(raw);
  }
  ...
  RobotGameToggleTeamCheckInRequest
      dco_decode_box_autoadd_robot_game_toggle_team_check_in_request(
          dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_robot_game_toggle_team_check_in_request(raw);
  }

  @protected
  Submerged dco_decode_box_autoadd_submerged(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_submerged(raw);
  }
  ...
  TmsCategory dco_decode_box_autoadd_tms_category(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_tms_category(raw);
  }
  ...
  TmsDuration dco_decode_box_autoadd_tms_duration(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_tms_duration(raw);
  }
  ...
  TournamentIntegrityCode dco_decode_box_autoadd_tournament_integrity_code(
      dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_tournament_integrity_code(raw);
  }
  ...
  TournamentIntegrityMessage
    ...
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_tournament_integrity_message(raw);
  }
  ...
  TournamentSeasonBlueprint dco_decode_box_autoadd_tournament_season_blueprint(
      dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_tournament_season_blueprint(raw);
  }
  ...
  Unearthed dco_decode_box_autoadd_unearthed(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_unearthed(raw);
  }
  ...
  List<BackupGetNamesInfo> dco_decode_list_backup_get_names_info(dynamic raw) {
    ...
    return (raw as List<dynamic>)
        .map(dco_decode_backup_get_names_info)
        .toList();
  }
  ...
  FllBlueprint? dco_decode_opt_box_autoadd_fll_blueprint(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null ? null : dco_decode_box_autoadd_fll_blueprint(raw);
  }
  ...
  RobotGameToggleTeamCheckInRequest
    ...
    if (arr.length != 2)
      throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
    return RobotGameToggleTeamCheckInRequest(
      teamNumber: dco_decode_String(arr[0]),
      matchNumber: dco_decode_String(arr[1]),
    );
  }
  ...
  TmsCategory dco_decode_tms_category(dynamic raw) {
    ...
    return TmsCategory(
      ...
      subCategories: dco_decode_list_String(arr[1]),
    );
  }
  ...
  TournamentErrorCode dco_decode_tournament_error_code(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return TournamentErrorCode.values[raw as int];
  }
  ...
  TournamentIntegrityCode dco_decode_tournament_integrity_code(dynamic raw) {
    ...
    switch (raw[0]) {
      case 0:
        return TournamentIntegrityCode_Error(
          dco_decode_tournament_error_code(raw[1]),
        );
      case 1:
        return TournamentIntegrityCode_Warning(
          dco_decode_tournament_warning_code(raw[1]),
        );
      default:
        throw Exception("unreachable");
    }
  ...
  TournamentIntegrityMessage dco_decode_tournament_integrity_message(
    ...
    if (arr.length != 5)
      throw Exception('unexpected arr length: expect 5 but see ${arr.length}');
    return TournamentIntegrityMessage.raw(
      integrityCode: dco_decode_tournament_integrity_code(arr[0]),
      message: dco_decode_String(arr[1]),
      teamNumber: dco_decode_opt_String(arr[2]),
      matchNumber: dco_decode_opt_String(arr[3]),
      sessionNumber: dco_decode_opt_String(arr[4]),
    );
  }

  @protected
  TournamentSeasonBlueprint dco_decode_tournament_season_blueprint(
      dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    if (arr.length != 2)
      throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
    return TournamentSeasonBlueprint(
  ...
  TournamentWarningCode dco_decode_tournament_warning_code(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return TournamentWarningCode.values[raw as int];
  }
  ...
  UserPermissions dco_decode_user_permissions(dynamic raw) {
    ...
    return UserPermissions.raw(
      ...
      referee: dco_decode_opt_box_autoadd_bool(arr[2]),
      headReferee: dco_decode_opt_box_autoadd_bool(arr[3]),
      judge: dco_decode_opt_box_autoadd_bool(arr[4]),
      judgeAdvisor: dco_decode_opt_box_autoadd_bool(arr[5]),
      scoreKeeper: dco_decode_opt_box_autoadd_bool(arr[6]),
      emcee: dco_decode_opt_box_autoadd_bool(arr[7]),
      av: dco_decode_opt_box_autoadd_bool(arr[8]),
    );
  }
  ...
  BackupGetNamesInfo sse_decode_backup_get_names_info(
    ...
    return BackupGetNamesInfo(fileName: var_fileName, timestamp: var_timestamp);
  }
  ...
  BackupGetNamesResponse sse_decode_backup_get_names_response(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_backups = sse_decode_list_backup_get_names_info(deserializer);
    return BackupGetNamesResponse(backups: var_backups);
  }
  ...
  BackupRestoreRequest sse_decode_backup_restore_request(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_fileName = sse_decode_String(deserializer);
    return BackupRestoreRequest(fileName: var_fileName);
  }
  ...
  BackupGetNamesInfo sse_decode_box_autoadd_backup_get_names_info(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_backup_get_names_info(deserializer));
  }
  ...
  BackupGetNamesResponse sse_decode_box_autoadd_backup_get_names_response(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_backup_get_names_response(deserializer));
  }
  ...
  BackupRestoreRequest sse_decode_box_autoadd_backup_restore_request(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_backup_restore_request(deserializer));
  }
  ...
  RobotGameToggleTeamCheckInRequest
      sse_decode_box_autoadd_robot_game_toggle_team_check_in_request(
          SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_robot_game_toggle_team_check_in_request(deserializer));
  }

  @protected
  Submerged sse_decode_box_autoadd_submerged(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_submerged(deserializer));
  }
  ...
  @protected
  TmsCategory sse_decode_box_autoadd_tms_category(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_tms_category(deserializer));
  }
  ...
  @protected
  TmsDuration sse_decode_box_autoadd_tms_duration(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_tms_duration(deserializer));
  }
  ...
  TournamentIntegrityCode sse_decode_box_autoadd_tournament_integrity_code(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_tournament_integrity_code(deserializer));
  }
  ...
  TournamentIntegrityMessage
      sse_decode_box_autoadd_tournament_integrity_message(
          SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_tournament_integrity_message(deserializer));
  }
  ...
  TournamentSeasonBlueprint sse_decode_box_autoadd_tournament_season_blueprint(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_tournament_season_blueprint(deserializer));
  }
  ...
  Unearthed sse_decode_box_autoadd_unearthed(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_unearthed(deserializer));
  }
  ...
  UserInsertRequest sse_decode_box_autoadd_user_insert_request(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_user_insert_request(deserializer));
  }
  ...
  UserPermissions sse_decode_box_autoadd_user_permissions(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_user_permissions(deserializer));
  }
  ...
  UserRemoveRequest sse_decode_box_autoadd_user_remove_request(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_user_remove_request(deserializer));
  }
  ...
  List<BackupGetNamesInfo> sse_decode_list_backup_get_names_info(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <BackupGetNamesInfo>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_backup_get_names_info(deserializer));
    }
    return ans_;
  }
  ...
  FllBlueprint? sse_decode_opt_box_autoadd_fll_blueprint(
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_fll_blueprint(deserializer));
    } else {
      return null;
    }
  }
  ...
  QuestionRule sse_decode_question_rule(SseDeserializer deserializer) {
    ...
    return QuestionRule.raw(condition: var_condition, output: var_output);
  }
  ...
  RobotGameToggleTeamCheckInRequest
    ...
    var var_matchNumber = sse_decode_String(deserializer);
    return RobotGameToggleTeamCheckInRequest(
        teamNumber: var_teamNumber, matchNumber: var_matchNumber);
  }
  ...
  TmsCategory sse_decode_tms_category(SseDeserializer deserializer) {
    ...
    var var_subCategories = sse_decode_list_String(deserializer);
    return TmsCategory(
        category: var_category, subCategories: var_subCategories);
  }
  ...
  TmsDate sse_decode_tms_date(SseDeserializer deserializer) {
    ...
    return TmsDate.raw(year: var_year, month: var_month, day: var_day);
  }
  ...
  TmsDateTime sse_decode_tms_date_time(SseDeserializer deserializer) {
    ...
    return TmsDateTime.raw(date: var_date, time: var_time);
  }
  ...
  TmsTime sse_decode_tms_time(SseDeserializer deserializer) {
    ...
    return TmsTime.raw(hour: var_hour, minute: var_minute, second: var_second);
  }
  ...
  TournamentErrorCode sse_decode_tournament_error_code(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var inner = sse_decode_i_32(deserializer);
    return TournamentErrorCode.values[inner];
  }
  ...
  TournamentIntegrityCode sse_decode_tournament_integrity_code(
    ...
    switch (tag_) {
      case 0:
        var var_field0 = sse_decode_tournament_error_code(deserializer);
        return TournamentIntegrityCode_Error(var_field0);
      case 1:
        var var_field0 = sse_decode_tournament_warning_code(deserializer);
        return TournamentIntegrityCode_Warning(var_field0);
      default:
        throw UnimplementedError('');
    }
  }
  ...
  TournamentIntegrityMessage sse_decode_tournament_integrity_message(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_integrityCode = sse_decode_tournament_integrity_code(deserializer);
    var var_message = sse_decode_String(deserializer);
    var var_teamNumber = sse_decode_opt_String(deserializer);
    var var_matchNumber = sse_decode_opt_String(deserializer);
    var var_sessionNumber = sse_decode_opt_String(deserializer);
    return TournamentIntegrityMessage.raw(
        integrityCode: var_integrityCode,
        message: var_message,
        teamNumber: var_teamNumber,
        matchNumber: var_matchNumber,
        sessionNumber: var_sessionNumber);
  ...
  TournamentSeasonBlueprint sse_decode_tournament_season_blueprint(
    ...
    return TournamentSeasonBlueprint(
        title: var_title, blueprint: var_blueprint);
  }
  ...
  TournamentWarningCode sse_decode_tournament_warning_code(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var inner = sse_decode_i_32(deserializer);
    return TournamentWarningCode.values[inner];
  }
  ...
  UserInsertRequest sse_decode_user_insert_request(
    ...
    return UserInsertRequest(userId: var_userId, user: var_user);
  }
  ...
  UserPermissions sse_decode_user_permissions(SseDeserializer deserializer) {
    ...
    var var_judgeAdvisor = sse_decode_opt_box_autoadd_bool(deserializer);
    var var_scoreKeeper = sse_decode_opt_box_autoadd_bool(deserializer);
    var var_emcee = sse_decode_opt_box_autoadd_bool(deserializer);
    ...
    return UserPermissions.raw(
        ...
        judge: var_judge,
        judgeAdvisor: var_judgeAdvisor,
        scoreKeeper: var_scoreKeeper,
        emcee: var_emcee,
        av: var_av);
  }
  ...
  UserRemoveRequest sse_decode_user_remove_request(
    ...
    return UserRemoveRequest(userId: var_userId);
  }
  ...
  void sse_encode_backup_get_names_response(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_list_backup_get_names_info(self.backups, serializer);
  }
  ...
  void sse_encode_box_autoadd_backup_get_names_info(
      BackupGetNamesInfo self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_backup_get_names_info(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_backup_get_names_response(
      BackupGetNamesResponse self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_backup_get_names_response(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_backup_restore_request(
      BackupRestoreRequest self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_backup_restore_request(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_robot_game_toggle_team_check_in_request(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_robot_game_toggle_team_check_in_request(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_submerged(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_submerged(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_tms_category(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_tms_category(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_tms_duration(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_tms_duration(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_tournament_integrity_code(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_tournament_integrity_code(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_tournament_integrity_message(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_tournament_integrity_message(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_tournament_season_blueprint(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_tournament_season_blueprint(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_unearthed(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_unearthed(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_user_insert_request(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_user_insert_request(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_user_permissions(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_user_permissions(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_user_remove_request(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_user_remove_request(self, serializer);
  }
  ...
  void sse_encode_list_backup_get_names_info(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_backup_get_names_info(item, serializer);
    }
  }
  ...
  void sse_encode_opt_box_autoadd_fll_blueprint(
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_fll_blueprint(self, serializer);
    }
  }
  ...
  void sse_encode_tms_category(TmsCategory self, SseSerializer serializer) {
    ...
    sse_encode_list_String(self.subCategories, serializer);
  }
  ...
  void sse_encode_tournament_integrity_code(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    switch (self) {
      case TournamentIntegrityCode_Error(field0: final field0):
        sse_encode_i_32(0, serializer);
        sse_encode_tournament_error_code(field0, serializer);
      case TournamentIntegrityCode_Warning(field0: final field0):
        sse_encode_i_32(1, serializer);
        sse_encode_tournament_warning_code(field0, serializer);
    }
  }
  ...
  void sse_encode_tournament_integrity_message(
      TournamentIntegrityMessage self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_tournament_integrity_code(self.integrityCode, serializer);
    sse_encode_String(self.message, serializer);
    sse_encode_opt_String(self.teamNumber, serializer);
    sse_encode_opt_String(self.matchNumber, serializer);
    sse_encode_opt_String(self.sessionNumber, serializer);
  }
  ...
  void sse_encode_user_permissions(
    ...
    sse_encode_opt_box_autoadd_bool(self.judgeAdvisor, serializer);
    sse_encode_opt_box_autoadd_bool(self.scoreKeeper, serializer);
    sse_encode_opt_box_autoadd_bool(self.emcee, serializer);
    sse_encode_opt_box_autoadd_bool(self.av, serializer);
  }
