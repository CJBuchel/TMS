...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1278959220;
...
fn pde_ffi_dispatcher_sync_impl(func_id: i32, ptr: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr, rust_vec_len: i32, data_len: i32) -> flutter_rust_bridge::for_generated::WireSyncRust2DartSse {
  ...
  match func_id {
    ...
    302 => wire__crate__infra__database_schemas__user__user_default_impl(ptr, rust_vec_len, data_len),
    303 => wire__crate__infra__database_schemas__user__user_from_json_string_impl(ptr, rust_vec_len, data_len),
    304 => wire__crate__infra__database_schemas__user__user_get_permissions_impl(ptr, rust_vec_len, data_len),
    305 => wire__crate__infra__database_schemas__user__user_has_permission_access_impl(ptr, rust_vec_len, data_len),
    306 => wire__crate__infra__database_schemas__user__user_has_role_impl(ptr, rust_vec_len, data_len),
    307 => wire__crate__infra__database_schemas__user__user_has_role_access_impl(ptr, rust_vec_len, data_len),
    308 => wire__crate__infra__network_schemas__user_requests__user_insert_request_default_impl(ptr, rust_vec_len, data_len),
    309 => wire__crate__infra__network_schemas__user_requests__user_insert_request_from_json_string_impl(ptr, rust_vec_len, data_len),
    310 => wire__crate__infra__network_schemas__user_requests__user_insert_request_to_json_string_impl(ptr, rust_vec_len, data_len),
    311 => wire__crate__infra__network_schemas__user_requests__user_insert_request_to_schema_impl(ptr, rust_vec_len, data_len),
    312 => wire__crate__infra__database_schemas__user__user_new_impl(ptr, rust_vec_len, data_len),
    313 => wire__crate__infra__database_schemas__user__user_permissions_default_impl(ptr, rust_vec_len, data_len),
    314 => wire__crate__infra__database_schemas__user__user_permissions_from_json_string_impl(ptr, rust_vec_len, data_len),
    315 => wire__crate__infra__database_schemas__user__user_permissions_from_roles_impl(ptr, rust_vec_len, data_len),
    316 => wire__crate__infra__database_schemas__user__user_permissions_get_merged_permissions_impl(ptr, rust_vec_len, data_len),
    317 => wire__crate__infra__database_schemas__user__user_permissions_get_roles_impl(ptr, rust_vec_len, data_len),
    318 => wire__crate__infra__database_schemas__user__user_permissions_has_role_access_impl(ptr, rust_vec_len, data_len),
    319 => wire__crate__infra__database_schemas__user__user_permissions_new_impl(ptr, rust_vec_len, data_len),
    320 => wire__crate__infra__database_schemas__user__user_permissions_to_json_string_impl(ptr, rust_vec_len, data_len),
    321 => wire__crate__infra__database_schemas__user__user_permissions_to_schema_impl(ptr, rust_vec_len, data_len),
    322 => wire__crate__infra__network_schemas__user_requests__user_remove_request_default_impl(ptr, rust_vec_len, data_len),
    ...
    326 => wire__crate__infra__database_schemas__user__user_to_json_string_impl(ptr, rust_vec_len, data_len),
    327 => wire__crate__infra__database_schemas__user__user_to_schema_impl(ptr, rust_vec_len, data_len),
    _ => unreachable!(),
  }
}
